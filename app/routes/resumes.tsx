    ...
    return (
        <main className="!pt-0">
            ...
            <div className="flex flex-row w-full  max-lg:flex-col-reverse">
                <section
                    className="feedback-section bg-[url(/images/bg-small.svg)] bg-cover h-[100vh] sticky top-0 justify-center items-center">
                    {imageUrl && resumeUrl && (
                        <div
                ...
                <section className="feedback-section">
                    ...
                    {feedback ? <div className="flex flex-col animate-in fade-in duration-1000">
